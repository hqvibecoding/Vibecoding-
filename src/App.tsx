...
function AppContent() {
  ...
  return (
    <main className={`min-h-[100dvh] transition-colors duration-700 selection:bg-white selection:text-black ${
      ...
      {!selectedItem && <Footer onAdminClick={() => setIsLoginOpen(true)} onLegalClick={setLegalType} theme={theme} />}
      ...
      <motion.a
        ...
        className={`fixed bottom-6 right-6 sm:bottom-8 sm:right-8 z-[100] p-3 sm:p-4 rounded-full shadow-2xl transition-transform hover:scale-110 active:scale-95 ${
