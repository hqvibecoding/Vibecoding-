...
export default function Header() {
  ...
  return (
    <header className="fixed top-0 left-0 w-full z-[100] px-6 md:px-12 py-6 md:py-8 flex justify-between items-center mix-blend-difference pointer-events-none">
      <div className="pointer-events-auto">
        <span className="text-white font-['Italiana'] text-lg md:text-2xl tracking-[0.3em] md:tracking-[0.4em] uppercase">
          Vibe Coding
        </span>
      </div>
